...
func (r *Registry) IsEnabled(exec *ssh.Executor) bool {
	return services.ServiceUp(exec, dir, "registry") || r.InstanceEnabled(r.serverID, serviceType)
}
